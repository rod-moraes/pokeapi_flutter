                                  ...
                                  TextSpan(text: "HP: ", children: [
                                    TextSpan(
                                        text: pokemon.stats[0]['base_stat']
                                                ?.toString() ??
                                            '0'),
                                    _progressBar(double.parse(pokemon.stats[0]
                                                ['base_stat']
                                            ?.toString() ??
                                        '0')),
                                  ])),
                                  ...
                                  TextSpan(text: "Attack: ", children: [
                                    TextSpan(
                                        text: pokemon.stats[1]['base_stat']
                                                ?.toString() ??
                                            '0'),
                                    _progressBar(double.parse(pokemon.stats[1]
                                                ['base_stat']
                                            ?.toString() ??
                                        '0')),
                                  ])),
                                  ...
                                  TextSpan(text: "Defense: ", children: [
                                    TextSpan(
                                        text: pokemon.stats[2]['base_stat']
                                                ?.toString() ??
                                            '0'),
                                    _progressBar(double.parse(pokemon.stats[2]
                                                ['base_stat']
                                            ?.toString() ??
                                        '0')),
                                  ])),
                                  ...
                                  TextSpan(text: "Sp.Atk: ", children: [
                                    TextSpan(
                                        text: pokemon.stats[3]['base_stat']
                                                ?.toString() ??
                                            '0'),
                                    _progressBar(double.parse(pokemon.stats[3]
                                                ['base_stat']
                                            ?.toString() ??
                                        '0')),
                                  ])),
                                  ...
                                  TextSpan(text: "Sp.Def: ", children: [
                                    TextSpan(
                                        text: pokemon.stats[4]['base_stat']
                                                ?.toString() ??
                                            '0'),
                                    _progressBar(double.parse(pokemon.stats[4]
                                                ['base_stat']
                                            ?.toString() ??
                                        '0')),
                                  ])),
                                  ...
                                  TextSpan(text: "Speed: ", children: [
                                    TextSpan(
                                        text: pokemon.stats[5]['base_stat']
                                                ?.toString() ??
                                            '0'),
                                    _progressBar(double.parse(pokemon.stats[5]
                                                ['base_stat']
                                            ?.toString() ??
                                        '0')),
                                  ])),
